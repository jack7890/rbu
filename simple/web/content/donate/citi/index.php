        ...
        <div class="wrapper">
            ...
            <section class="participation">
                ...
                <div class="participation__fill" style="height:$percent%">
                    <h3 class="participation__fill__title">$left more people to reach 100%</h3>
                </div>
            </section>
            ...
            <section class="pledged obscured">
                <div class="pledged__contributions">
                    ...
                    <aside class="pledged__contributions__share">
                        ...
                        <h5 class="pledged__contributions__share__url"><a href="form.html">raisedby.us/impact/thrillist</a></h5>
                    </aside>
                </div>
            </section>
