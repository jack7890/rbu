...
<html class="no-js" lang="en">
  <head>
    ...
    <title>RaisedBy.Us</title>
    <link rel="stylesheet" href="web/content/css/foundation.css" />
    <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="web/content/css/rbu.css" />
    ...
    ga('create', 'UA-48362904-1', 'raisedby.us');
    ga('send', 'pageview');
  ...
  <div class="off-canvas-wrap">
    ...
    <aside class="right-off-canvas-menu">
      <ul class="off-canvas-list">
        ...
        <li><a href="/ambassadors/">Ambassador Programs</a></li>
    ...
    <header>
      <div class="row">
        <div class="small-4 columns">
          <h1><a href="/" class="red">Raisedby.Us</a></h1>
        </div>
        <div class="small-8 columns clearfix">
          <nav id="main-nav" class="show-for-large-up">
            <ul class="right">
              <li id="nav-what-we-do">
                <a href="#" data-dropdown="dd-what-we-do">What We Do <i class="fa fa-angle-down"></i></a>
                <ul id="dd-what-we-do" class="f-dropdown" data-dropdown-content>
                  <li><a href="/workplace-giving/">Workplace Giving</a></li>
                  <li><a href="/education/">Education Programs</a></li>
                  <li><a href="/ambassadors/">Ambassador Programs</a></li>
                </ul>
              ...
              <li id="nav-get-involved">
                <a href="/get-involved/">Get Involved</a>
              </li>
            </ul>
          </nav>
          <div class="mobile-nav hide-for-large-up right right-off-canvas-toggle">
