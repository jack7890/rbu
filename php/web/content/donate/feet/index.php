...
$average = number_format(round($total / $num_employ, 0));
        ...
        <div class="wrapper">
            ...
            <section class="participation">
                ...
                <div class="participation__fill" style="height:$percent%">
                    <h3 class="participation__fill__title">$left more people needed to reach $totpercent% so we can be the company with the highest RaisedBy.Us participation</h3>
                </div>
            </section>
            ...
            <section class="pledged obscured">
                <div class="pledged__contributions">
                    ...
                    <aside class="pledged__contributions__share">
                        ...
                        <h5 class="pledged__contributions__share__url"><a href="donate.php">raisedby.us/donate/$pieces[4]/donate.php</a></h5>
                    </aside>
                </div>
            </section>
