...
elseif ($percent >= 50 && $percent < 60){
	$totpercent = 60;
	$left = round($num_employ_total * 0.6,0) - $num_employ;
}
elseif ($percent >= 60 && $percent < 70){
	$totpercent = 70;
	$left = round($num_employ_total * 0.7,0) - $num_employ;
}
elseif ($percent >= 70 && $percent < 80){
	$totpercent = 80;
	$left = round($num_employ_total * 0.8,0) - $num_employ;
}
elseif ($percent >= 80 && $percent < 90){
	$totpercent = 90;
	$left = round($num_employ_total * 0.9,0) - $num_employ;
}
else{
	$totpercent = 100;
        ...
        <div class="wrapper">
            ...
            <section class="participation">
                ...
                <div class="participation__fill" style="height:$percent%">
                    <h3 class="participation__fill__title">$left more people needed to reach $totpercent% participation</h3>
                </div>
            </section>
